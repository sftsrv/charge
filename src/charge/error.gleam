...
pub type ChargeResult(r) =
  Result(r, ChargeError)
...
/// the happy case
pub fn collate_errors(results: List(ChargeResult(r))) -> ChargeResult(List(r)) {
...
fn error_to_string_rec(err: ChargeError, indent) {
  case err {
